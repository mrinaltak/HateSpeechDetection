...
##test these models
python continuous_prompt.py --epochs 0 --lr 0.01 --model BERT --lr_decay 0.5 --model_path FixCont_BERT_20_0.01_8_0.5/ckpt_epoch_3.pth >bert_performance.txt
...
##cross eval
python continuous_prompt_hateval.py --epochs 0 --lr 0.01 --model ELECTRA --lr_decay 0.5 --n_tasks 4 --prefix cross --model_path Continuous_ELECTRA_20_0.01_8_0.5/ckpt_epoch_3.pth >outputs/cross_electra1.txt
